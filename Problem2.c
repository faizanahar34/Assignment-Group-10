...
int main()
{
    ...
    //w1=3,theta1=65,theta1rad,lamda1=530

    //variables for red light--
    //w2=2,theta2=?,theta2rad,lambda2=700


    printf("====| Diffraction Grating Problem By Group 10 |====\n\n");


    theta1rad=theta1*3.14159265/180.0; //converting angle of green light from degree to rad

    d = (w1*lambda1)/sin(theta1rad); //calculating d

    sin_theta2= (w2*lambda2)/d; //calculating sin theta of red light
